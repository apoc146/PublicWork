...
This directory contains work on implementing robot motion algorithms, control systems, path planning and kinematic etc. Each sub-directory has it's own readme explaing in detail the work.

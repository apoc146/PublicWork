...
Here we implement learning based Motion Planning Using MPNET

Content:
* [MPNET](https://arxiv.org/abs/1907.06013)
* Lazy Vertex Contraction
* Comparison of MPNET and RRT*
* On 2D and 3D environement
...
* Code is avaliable on request
* Results can be found at [Report](./REPORT.pdf)
...
<!-- All the installation Instruction have been specified in the notebook -->
